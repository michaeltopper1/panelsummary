...
## same as modelsummary's gof_map_build.
## with the exception of the mean at the beginning to account for mean
## the mean is the whole point of using this function.

...
- Small bug fixes for `fixest` attribute names introduced in `fixest`
  v0.14.0 (Thank you lrberge.)
...
- Updated to fix `modelsummary` 1.3 breaking change update. Package now
  depends on `modelsummary` version 1.3 and above.
